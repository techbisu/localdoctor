      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-start">
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              ...
              {lab.status === "VERIFIED" && (
                <Badge className="bg-teal-700 text-white text-xs">Verified</Badge>
              )}
            </div>
          </div>
        </div>
        ...
        {lab.services?.length > 0 && (
          <div className="flex flex-wrap gap-1 mt-2">
            {lab.services.slice(0, 4).map((s: any) => (
        ...
        <div className="flex gap-3 mt-2">
          ...
          {lab.phone && (
            <a href={`tel:${lab.phone}`} className="text-sm text-teal-700 font-medium hover:underline flex items-center gap-1">
