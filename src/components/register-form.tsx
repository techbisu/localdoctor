...
const schema = z.object({
  ...
  entityName: z.string().min(2, 'Enter practice name'),
      ...
      <CardContent className='pt-6'>
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
          <div>
            ...
            <Select onValueChange={(v) => setValue('role', v as any)} defaultValue={watch('role')}>
              ...
              <SelectContent>
                ...
                <SelectItem value='PHARMACY'>Pharmacy / Medicine Shop</SelectItem>
                <SelectItem value='LAB'>Medical Test Lab</SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            <div>
              <Label>Practice/Shop Name</Label>
              <Input {...register('entityName')} placeholder='Business name' />
              {errors.entityName && <p className='text-sm text-red-500 mt-1'>{errors.entityName.message}</p>}
            </div>
          </div>
          <div>
            <Label>Email</Label>
